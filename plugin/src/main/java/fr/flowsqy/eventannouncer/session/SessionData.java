...
public record SessionData(@NotNull String destinationServer, int duration, int playerByIteration, int period,
        ...
        @NotNull BaseComponent alreadyConnectedMessage, @NotNull BaseComponent alreadyInQueueMessage,
        @NotNull BaseComponent notOpenedMessage, @NotNull BaseComponent successMessage) {
}
